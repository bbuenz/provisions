...
implements Verifier<AddressProof, AddressVerificationData> {
    ...
    public void verify(AddressProof proof, AddressVerificationData data) {
        ...
        BigInteger transmittedChallenge = proof.getChallenge();
        ...
        BigInteger computedChallenge = ProofUtils.computeChallenge(g, h, data.getPublicKey(), b, proof.getCommitmentBalance(), proof.getCommitmentXHat(), a1, a2, a3);
